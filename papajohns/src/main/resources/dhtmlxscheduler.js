...
window.dhtmlXScheduler = window.scheduler = {
    ...
    function() {
        ...
        date: {
            ...
            day_short: ["일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"]
        },
        labels: {
            dhx_cal_today_button: "오늘날짜 보기",
            day_tab: "일",
            week_tab: "주",
            month_tab: "월",
            new_event: "새로운 이벤트",
            ...
            icon_delete: "삭제",
            confirm_closing: "",
            confirm_deleting: "이벤트를 정말 삭제하시겠습니까?",
            section_description: "설명",
            section_time: "시간 간격",
            full_day: "하루 종일",
            confirm_recurring: "Do you want to edit the whole set of repeated events?",
            section_recurring: "Repeat event",
            button_recurring: "비활성",
            button_recurring_open: "활성",
    ...
    function() {
        ...
        time: {
            render: function(e) {
                e.time_format || (e.time_format = ["%Y", "%m", "%d", "%H:%i"]), e._time_format_order = {};
                var t = e.time_format,
                    i = scheduler.config,
