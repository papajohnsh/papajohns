...
public class PageMaker {
	...
	public static String goPage(String pagename, int total_cnt, int listSize, int pageSize, int cp){
		...
		int page_cnt=(total_cnt/listSize)+1;//������ �� ���ϱ�
		if(total_cnt%listSize==0)page_cnt--;//����(listSize�� �� �������� ���� -1 ���ҽ�Ŵ)

		int group_num=cp/pageSize;//�׷��ȣ ���ϱ�(����� ��ġ�� ���Ե� �׷��ȣ)
		...
		for(int i=(group_num*pageSize)+1;
				i<=(group_num*pageSize)+pageSize;i++){
			sb.append("<a href='");
			sb.append(pagename);
			sb.append("?cp=");
			sb.append(i);
