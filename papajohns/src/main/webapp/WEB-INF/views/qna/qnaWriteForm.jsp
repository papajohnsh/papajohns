...
<!-- Content Wrapper. Contains page content -->
   		...
   		<div class="col-xs-2"></div>
			<div class="col-xs-8">
       		<form name="qnaWrite" action="qnaWrite.do" method="post" enctype="multipart/form-data">
             <div class="box">
                <div class="box-header" align="center">
                  <h3 class="box-title"><span class="glyphicons glyphicons-edit">질문게시판 글쓰기</span></h3>
                </div><!-- /.box-header -->
