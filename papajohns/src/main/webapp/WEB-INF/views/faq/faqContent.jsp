...
<!-- Left side column. contains the logo and sidebar -->
   <aside class="main-sidebar">
     ...
     <section class="sidebar">
       ...
       <c:if test="${!empty sid}">
         <div class="pull-left image"> <img src="resource/data/${sid }/profile.jpg" onerror="this.src='//ssl.gstatic.com/accounts/ui/avatar_2x.png'" height="300px" width="300px" class="img-circle" >
         </div>
        </c:if>
