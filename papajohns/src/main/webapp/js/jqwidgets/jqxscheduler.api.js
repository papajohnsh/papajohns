...
(function(a) {
    ...
    a.jqx.scheduler.utilities = {
        ...
        getEndOfWeek: function(d, e, c) {
            var f = 7;
            var b = that.getStartOfWeek(d, dateTimeFormat, c);
            return b.addDays(f)
        },
    ...
    a.jqx.scheduler.recurrentAppointmentsList = function() {
        ...
        b.getNextAppointment = function(h) {
            ...
            for (var e = 0; e < d; e++) {
                ...
                if (h.to.addDays(f) < k || b.to.addDays(f) < k) {
                    b.currentTime = null;
                    return false
                }
                var g = true;
            ...
            switch (c.freq) {
                ...
                case "weekly":
                    if (c.byweekday) {
                        ...
                        g = g.addDays(7 * (c.step * c.interval));
                        if (c.step >= 1) {
                            g = g.addDays(-c.from.dayOfWeek());
                            var s = g.addDays(7)
                        } else {
                            var s = g.addDays(7 - c.from.dayOfWeek())
                        }
                        var e = g;
                        for (var z = 0; z < 7; z++) {
                            if (j[e.dayOfWeek()] === c.byweekday[c.current]) {
                                break
                            }
                            if (e >= s) {
                                break
                ...
                case "monthly":
                    if (c.bynweekday.length > 0) {
                        ...
                        for (var y = 0; y < c.bynweekday.length; y++) {
                            var q = c.bynweekday[y][0],
                                x = c.bynweekday[y][1];
                            if (x < 0) {
                                z = m + (x + 1) * 7;
                                z -= d(c.wdaymask[z] - q, 7)
                            } else {
                                z = h + (x - 1) * 7;
                                z += d(7 - c.wdaymask[z] + q, 7)
                            }
                            if (h <= z && z <= m) {
                                c.nwdaymask[z] = 1
                            }
        ...
        c.canCreateNewOccurence = function(e, g) {
            ...
            switch (c.freq) {
                ...
                case "weekly":
                    ...
                    if (c.weekDays == {}) {
                        if (c.from.dayOfWeek() != start.dayOfWeek()) {
                            return false
                        }
                    } else {
                        if (!c.isDayOfWeekIncluded(e, g)) {
...
(function(a) {
    a.extend(a.jqx._jqxScheduler.prototype, {
        ...
        exportData: function(u) {
            var p = this;
            if (!a.jqx.dataAdapter.ArrayExporter) {
                throw "jqxScheduler: Missing reference to jqxdata.export.js!"
            }
            var w = this.exportSettings.serverURL;
            var f = this.exportSettings.characterSet;
            var A = this.exportSettings.fileName;
            if (A === undefined) {
                A = "jqxScheduler"
            }
            var p = this;
            if (u == "ical" || u == "ics") {
                if (p._resources.length > 1 && A && p.resourcesInMultipleICSFiles) {
                    var r = this.getAppointments();
                    for (var C = 0; C < p._resources.length; C++) {
                        var c = p._resources[C];
                        var t = new Array();
                        ...
                        F += "\nEND:VCALENDAR";
                        var g = F.length;
                        var o = new Uint8Array(new ArrayBuffer(g));
                        for (var z = 0; z < g; z++) {
                            o[z] = F.charCodeAt(z)
                        }
                        var b = new Blob([o], {
            ...
            var r = this.getDataAppointments();
            var y = new Array();
            var D = {};
            var q = {};
            ...
            var E = "column";
            var d = 1;
            var x = a(this.columns.records[0].element);
            var n = 0;
            a.each(this.appointmentDataFields, function(j, m) {
                ...
                D[m].width = 100;
                D[m].formatString = "";
                D[m].localization = p.schedulerLocalization;
                if (j == "from" || j == "to") {
                    D[m].type = "date";
                    D[m].formatString = p.exportSettings.dateTimeFormatString
                } else {
                    D[m].type = "string"
                }
                D[m].cellsAlign = "left";
                ...
                k = "cell" + e;
                E = "column" + d;
                if (u == "html" || u == "xls" || u == "pdf") {
                    var i = function(G, O, N, H, M, J, I, K, L) {
                        q[G] = {};
                        if (O == undefined) {
                            return
                        }
                        q[G]["font-size"] = O.css("font-size");
                        q[G]["font-weight"] = O.css("font-weight");
                        q[G]["font-style"] = O.css("font-style");
                        q[G]["background-color"] = p._getexportcolor(O.css("background-color"));
                        q[G]["color"] = p._getexportcolor(O.css("color"));
                        q[G]["border-color"] = p._getexportcolor(O.css("border-top-color"));
                        if (N) {
                            q[G]["text-align"] = "left"
                        } else {
                            q[G]["text-align"] = "left";
                            ...
                            if (I == "from" || I == "to") {
                                q[G]["dataType"] = "date";
                                q[G]["formatString"] = p.exportSettings.dateTimeFormatString
                            }
                        }
                        if (u == "html" || u == "pdf") {
                            q[G]["border-top-width"] = O.css("border-top-width");
                            q[G]["border-left-width"] = O.css("border-left-width");
                            q[G]["border-right-width"] = O.css("border-right-width");
                            q[G]["border-bottom-width"] = O.css("border-bottom-width");
                            q[G]["border-top-style"] = O.css("border-top-style");
                            q[G]["border-left-style"] = O.css("border-left-style");
                            q[G]["border-right-style"] = O.css("border-right-style");
                            q[G]["border-bottom-style"] = O.css("border-bottom-style");
                            if (N) {
                                if (n == 0) {
                                    q[G]["border-left-width"] = O.css("border-right-width")
                                }
                                q[G]["border-top-width"] = O.css("border-right-width");
                                q[G]["border-bottom-width"] = O.css("border-bottom-width")
                            } else {
                                if (n == 0) {
                                    q[G]["border-left-width"] = "1px"
                                }
                                q[G]["border-right-width"] = "1px"
                            }
                        }
                        if (N) {
                            D[m].style = G
                    ...
                    i(E, x, true, false, this, p, j);
                    d++;
                    i(k, l, false, false, this, p, j);
                    e++
                }
                n++
            });
            var v = a.jqx.dataAdapter.ArrayExporter(r, D, q, w);
            if (A == null) {
                this._renderrows();
                var s = v.exportTo(u);
                setTimeout(function() {
        ...
        getColors: function(g) {
            ...
            c = b[g];
            c = this.hexToRgba(b[g], 0.7).toString();
            e = b[g];
            var h = function(l) {
                var k = 105;
        ...
        initRepeatPanels: function(p, i, c) {
            ...
            var b = a("<div></div>");
            i.append(b);
            var j = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatString + "</div>").appendTo(b);
            var l = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(b);
            ...
            var o = function(H, A) {
                ...
                var E = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatEndString + "</div>").appendTo(u);
                var D = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(u);
                var G = a("<div style='position:relative; float:left;'><span style='margin-left:2px;'>" + h.schedulerLocalization.editDialogRepeatNeverString + "</span></div>").appendTo(D);
                G.jqxRadioButton({
                    rtl: h.rtl,
                    groupName: "end" + A,
                    theme: h.theme,
                ...
                var z = a("<div class='jqx-scheduler-edit-dialog-label'></div>").appendTo(u);
                var y = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(u);
                var F = a("<div style='position:relative;  float:left;'><span style='margin-left:2px;'>" + h.schedulerLocalization.editDialogRepeatAfterString + "</span></div>").appendTo(y);
                F.jqxRadioButton({
                    rtl: h.rtl,
                    groupName: "end" + A,
                    theme: h.theme,
                ...
                var v = a("<div style='float: left; margin-left: 5px; line-height:25px;'>" + h.schedulerLocalization.editDialogRepeatOccurrencesString + "</div>").appendTo(y);
                ...
                var x = a("<div class='jqx-scheduler-edit-dialog-label'></div>").appendTo(u);
                var w = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(u);
                var t = a("<div style='position:relative; float:left;'><span style='margin-left:2px;'>" + h.schedulerLocalization.editDialogRepeatOnString + "</span></div>").appendTo(w);
                t.jqxRadioButton({
                    rtl: h.rtl,
                    groupName: "end" + A,
                    theme: h.theme,
            ...
            var q = function() {
                ...
                var ad = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatEveryString + "</div>").appendTo(z);
                var ay = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(z);
                ...
                var ag = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatEveryString + "</div>").appendTo(E);
                var t = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(E);
                ...
                var F = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatOnString + "</div>").appendTo(E);
                var Z = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(E);
                ...
                var av = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatEveryString + "</div>").appendTo(U);
                ...
                var an = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatOnString + "</div>").appendTo(U);
                ...
                var O = a("<div class='jqx-scheduler-edit-dialog-label'></div>").appendTo(U);
                ...
                var R = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatEveryString + "</div>").appendTo(aq);
                var ak = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(aq);
                ...
                var N = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogRepeatOnString + "</div>").appendTo(aq);
                var ah = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(aq);
                ...
                var ae = a("<div class='jqx-scheduler-edit-dialog-label'></div>").appendTo(aq);
                var s = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(aq);
            ...
            var g = a("<div></div>");
            i.append(g);
            var f = a("<div class='jqx-scheduler-edit-dialog-label'>" + h.schedulerLocalization.editDialogExceptionsString + "</div>").appendTo(g);
            var e = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(g);
            var d = a("<div style='position:relative; top: 6px;'>" + h.schedulerLocalization.editDialogResetExceptionsString + "</div>").appendTo(e);
            d.jqxCheckBox({
                height: 25,
                width: 25,
                theme: h.theme
        ...
        _initDialog: function(b, c) {
            ...
            if (m._editDialog == null) {
                ...
                a(q).jqxWindow({
                    ...
                    initContent: function() {
                        ...
                        var A = a("<div></div>");
                        H.append(A);
                        var C = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogSubjectString + "</div>").appendTo(A);
                        var ad = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(A);
                        ...
                        var P = a("<div></div>");
                        H.append(P);
                        var z = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogLocationString + "</div>").appendTo(P);
                        var Z = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(P);
                        ...
                        var L = a("<div></div>");
                        H.append(L);
                        var X = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogFromString + "</div>").appendTo(L);
                        var av = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(L);
                        ...
                        var aC = a("<div></div>");
                        H.append(aC);
                        var y = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogToString + "</div>").appendTo(aC);
                        var Y = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(aC);
                        ...
                        var t = a("<div></div>");
                        H.append(t);
                        var R = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogAllDayString + "</div>").appendTo(t);
                        var ar = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(t);
                        var ai = a("<div style='position:relative;'></div>").appendTo(ar);
                        ai.jqxCheckBox({
                            rtl: m.rtl,
                            height: 25,
                            width: 25,
                        ...
                        if (m._views[m._view].type.indexOf("month") >= 0 || (d && d.equals(h)) || (h && h.equals(a.jqx.scheduler.utilities.getEndOfDay(h)))) {
                            m.editDialogFields.allDay.val(true)
                        }
                        var w = a("<div></div>");
                        H.append(w);
                        var W = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogTimeZoneString + "</div>").appendTo(w);
                        var at = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(w);
                        ...
                        var K = a("<div></div>");
                        H.append(K);
                        var aA = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogDescriptionString + "</div>").appendTo(K);
                        var O = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(K);
                        ...
                        var ac = a("<div></div>");
                        H.append(ac);
                        var aD = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogColorString + "</div>").appendTo(ac);
                        var Q = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(ac);
                        ...
                        var ah = a("<div></div>");
                        H.append(ah);
                        var az = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogStatusString + "</div>").appendTo(ah);
                        var N = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(ah);
                        ...
                        var ag = a("<div></div>");
                        H.append(ag);
                        var M = a("<div class='jqx-scheduler-edit-dialog-label'>" + m.schedulerLocalization.editDialogResourceIdString + "</div>").appendTo(ag);
                        var am = a("<div class='jqx-scheduler-edit-dialog-field'></div>").appendTo(ag);
                        ...
                        var ae = a("<div></div>");
                        H.append(ae);
                        var al = a("<div style='width:100%;' class='jqx-scheduler-edit-dialog-field'></div>").appendTo(ae);
            ...
            m.addHandler(m._editDialog, "open", function(t) {
                ...
                setTimeout(function() {
                    var u = m.editAppointment ? m.editAppointment.boundAppointment : null;
                    if (m.editAppointment && m.editAppointment.rootAppointment) {
                        u = m.editAppointment.rootAppointment.boundAppointment
                    }
        ...
        _setAppointmentPropertiesToDialog: function(e, h, d, g) {
            ...
            if (!e) {
                ...
                if (f._views[f._view].type.indexOf("month") >= 0 || (h && h.equals(d)) || (d && d.equals(a.jqx.scheduler.utilities.getEndOfDay(d)))) {
    ...
    a.jqx.scheduler.dataView = function(b) {
        ...
        this.databind = function(c, i) {
            ...
            var f = function(o) {
                ...
                e._options.totalrecords = o.totalrecords;
                e._options.originaldata = o.originaldata;
                e._options.recordids = o.recordids;
                e._options.cachedrecords = new Array();
                e._options.pagenum = o.pagenum;
                e._options.pageable = o.pageable;
                if (c.type != undefined) {
                ...
                e._options.pagesize = o.pagesize
            };
            var m = function(o) {
                o.originaldata = e.originaldata;
                o.records = e.records;
                o.hierarchy = e.hierarchy;
                if (!o.scheduler.serverProcessing) {
                    o._sortData = null;
                    o._sortfield = null;
                    o._filteredData = null;
                    o._sortHierarchyData = null
                }
                if (!o.hierarchy) {
                    o.hierarchy = new Array();
                    e.hierarchy = new Array()
                }
                if (e._source.totalrecords) {
                    o.totalrecords = e._source.totalrecords
                } else {
                    if (e._source.totalRecords) {
                        o.totalrecords = e._source.totalRecords
                    } else {
                        if (o.hierarchy.length !== 0) {
                            o.totalrecords = o.hierarchy.length
                        } else {
                            o.totalrecords = o.records.length
                        }
                    }
                }
                o.cachedrecords = e.cachedrecords
            };
            f(this);
            this.source = c;
            if (i !== undefined) {
            ...
            switch (c.datatype) {
                ...
                case "tab":
                    ...
                    var k = function() {
                        var p = a.jqx.browser.msie && a.jqx.browser.version < 9;
                        var q = function() {
                            m(l);
                            l.update(e.records)
                        };
                    ...
                    e._source.loaderror = function(q, o, p) {
                        k()
                    };
                    if ((!l.scheduler.autoBind && l.scheduler.isInitialized) || l.scheduler.autoBind) {
                        e.dataBind()
