...
(function(a) {
    ...
    a.extend(a.jqx._jqxInput.prototype, {
            ...
            if (this.element.nodeName.toLowerCase() == "textarea") {
                ...
                if (this.element.nodeName.toLowerCase() == "div") {
                    ...
                    if (b.length > 0) {
                        ...
                        var c = this.baseHost.children();
                        var e = this;
                        a.each(c, function(g) {
                            a(this).addClass(e.toThemeProperty("jqx-input-group-addon"));
                            a(this).removeClass(e.toThemeProperty("jqx-rc-all"));
                            if (g == 0) {
                                a(this).addClass(e.toThemeProperty("jqx-rc-l"))
                            }
                            if (g == c.length - 1) {
                                a(this).addClass(e.toThemeProperty("jqx-rc-r"))
                            }
                            if (this != e.element) {
                                a(this).addClass(e.toThemeProperty("jqx-fill-state-normal"))
                            }
                        })
                    }
                }
        ...
        _updateSource: function() {
            ...
            var b = function(f) {
                ...
                e = a.map(f, function(h) {
                    ...
                    if (typeof h != "string" && h instanceof String == false) {
                        var g = "";
                        var i = "";
                        if (d.displayMember != "" && d.displayMember != undefined) {
                            if (h[d.displayMember]) {
                                g = h[d.displayMember]
                            }
                        }
            ...
            if (this.source && this.source._source) {
                ...
                if (this.adapter._source.localdata != null) {
                    ...
                    this.adapter.bindBindingUpdate(this.element.id, function(e) {
                    ...
                    this.adapter.bindDownloadComplete(this.element.id, function(e) {
                        d.source = b(d.adapter.records)
                    })
                }
        ...
        _refreshClasses: function(c) {
            var b = c ? "addClass" : "removeClass";
            this.host[b](this.toThemeProperty("jqx-widget-content"));
            this.host[b](this.toThemeProperty("jqx-input"));
            this.host[b](this.toThemeProperty("jqx-widget"));
            this.$popup[b](this.toThemeProperty("jqx-popup"));
            if (a.jqx.browser.msie) {
                this.$popup[b](this.toThemeProperty("jqx-noshadow"))
            }
            this.$popup[b](this.toThemeProperty("jqx-input-popup"));
            this.$popup[b](this.toThemeProperty("jqx-menu"));
            this.$popup[b](this.toThemeProperty("jqx-menu-vertical"));
            this.$popup[b](this.toThemeProperty("jqx-menu-dropdown"));
            this.$popup[b](this.toThemeProperty("jqx-widget"));
            this.$popup[b](this.toThemeProperty("jqx-widget-content"));
            if (this.roundedCorners) {
                this.host[b](this.toThemeProperty("jqx-rc-all"));
                this.$popup[b](this.toThemeProperty("jqx-rc-all"))
            }
            if (this.disabled) {
                this.host[b](this.toThemeProperty("jqx-fill-state-disabled"))
            } else {
            ...
            if (!this.baseHost) {
                ...
                if (this.height) {
                    ...
                    a.each(this.baseHost.children(), function() {
                        ...
                        if (this !== d.element) {
                            c += a(this).outerWidth() + 2
                        }
                    });
                    this.host.css("width", this.baseHost.width() - c - 4 + "px");
                    if (a.jqx.browser.msie && a.jqx.browser.version < 9) {
                        this.host.css("min-height", b + "px");
            ...
            if ("placeholder" in this.element) {
                ...
                if (this.element.value == "") {
                    ...
                    this.host.focus(function() {
                        if (b.element.value == b.placeHolder) {
                            b.element.value = ""
                        }
                    });
                    this.host.blur(function() {
                        if (b.element.value == "" || b.element.value == b.placeHolder) {
                            b.element.value = b.placeHolder
                        }
                    })
                }
            }
        ...
        select: function(d, e, b) {
            var f = this.$popup.find(".jqx-fill-state-pressed").attr("data-value");
            var c = this.$popup.find(".jqx-fill-state-pressed").attr("data-name");
            this.element.value = this.renderer(c, this.element.value);
            this.selectedItem = {
                label: c,
                value: f
            };
            this.host.attr("data-value", f);
            this.host.attr("data-label", c);
            this._raiseEvent("0", {
                item: {
                    label: c,
                    value: f
        ...
        val: function(b) {
            ...
            if (b && b.label) {
                ...
                this.host.attr("data-value", b.value);
                this.host.attr("data-label", b.label);
                this.value = b;
                this.element.value = b.label;
                return this.element.value
            }
            this.value = b;
            this.element.value = b;
            this.host.attr("data-value", b);
            this.host.attr("data-label", b);
            if (b && b.label) {
                this._raiseEvent("3", {
                    type: null,
                    item: {
        ...
        open: function() {
            ...
            this.$popup.appendTo(a(document.body)).css({
                position: "absolute",
            ...
            var b = 0;
            var d = this.$popup.children();
            a.each(d, function() {
                b += a(this).outerHeight(true) - 1
            });
            this.$popup.height(b);
            this.opened = true;
            this._raiseEvent("1", {
            ...
            b = a(b).map(function(e, f) {
                ...
                if (f.value != undefined) {
                    ...
                    if (f.label != undefined) {
                        ...
                        if (c.displayMember != undefined && c.displayMember != "") {
                            e = a(c.item).attr({
                                "data-name": f[c.displayMember],
                                "data-value": f[c.valueMember]
                            })
                        } else {
                            e = a(c.item).attr({
                                "data-value": f,
                ...
                e.find("a").html(c.highlight(g));
                var d = "";
                if (c.rtl) {
                    d = " " + c.toThemeProperty("jqx-rtl")
                }
                e[0].className = c.toThemeProperty("jqx-item") + " " + c.toThemeProperty("jqx-menu-item") + " " + c.toThemeProperty("jqx-rc-all") + d;
                return e[0]
            });
            b.first().addClass(this.toThemeProperty("jqx-fill-state-pressed"));
            this.$popup.html(b);
        ...
        next: function(c) {
            var d = this.$popup.find(".jqx-fill-state-pressed").removeClass(this.toThemeProperty("jqx-fill-state-pressed")),
                b = d.next();
            if (!b.length) {
                b = a(this.$popup.find("li")[0])
            }
        ...
        prev: function(c) {
            var d = this.$popup.find(".jqx-fill-state-pressed").removeClass(this.toThemeProperty("jqx-fill-state-pressed")),
                b = d.prev();
            if (!b.length) {
                b = this.$popup.find("li").last()
            }
            b.addClass(this.toThemeProperty("jqx-fill-state-pressed"))
        },
        addHandlers: function() {
            var b = this;
            b.addHandler(b.host, "focus", a.proxy(b.onFocus, b));
            b.addHandler(b.host, "blur", a.proxy(b.onBlur, b));
            b.addHandler(b.host, "change.jqxinput" + b.element.id, function(e) {
                if (!e.args) {
                    e.stopPropagation();
                    e.preventDefault();
            ...
            b.addHandler(b.host, "keypress", a.proxy(b.keypress, b));
            b.addHandler(b.host, "keyup", a.proxy(b.keyup, b));
            b.addHandler(b.host, "keydown", a.proxy(b.keydown, b));
            b.addHandler(b.$popup, "mousedown", a.proxy(b.click, b));
            if (b.host.on) {
                b.$popup.on("mouseenter", "li", a.proxy(b.mouseenter, b))
            } else {
                b.$popup.bind("mouseenter", "li", a.proxy(b.mouseenter, b))
            }
        },
        removeHandlers: function() {
            var b = this;
            b.removeHandler(b.host, "change.jqxinput" + b.element.id);
            b.removeHandler(b.host, "focus", a.proxy(b.onFocus, this));
            b.removeHandler(b.host, "blur", a.proxy(b.onBlur, this));
            b.removeHandler(b.host, "keypress", a.proxy(b.keypress, this));
            b.removeHandler(b.host, "keyup", a.proxy(b.keyup, this));
            b.removeHandler(b.host, "keydown", a.proxy(b.keydown, this));
            b.removeHandler(b.$popup, "mousedown", a.proxy(b.click, this));
            if (b.host.off) {
                b.$popup.off("mouseenter", "li", a.proxy(b.mouseenter, this))
            } else {
                b.$popup.unbind("mouseenter", "li", a.proxy(b.mouseenter, this))
            }
        },
        move: function(b) {
            if (!this.opened) {
        ...
        mouseenter: function(b) {
            ...
            a(b.currentTarget).addClass(this.toThemeProperty("jqx-fill-state-pressed"))
        }
    })
})(jqxBaseFramework);