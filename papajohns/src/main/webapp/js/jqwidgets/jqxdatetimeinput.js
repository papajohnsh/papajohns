...
(function(a) {
    ...
    a.extend(a.jqx._jqxDateTimeInput.prototype, {
        ...
        _arrange: function() {
            ...
            this.calendarButton[0].style.width = g + 1 + "px";
            this.calendarButton[0].style.left = 1 + b + "px";
            this.timeButton[0].style.width = g + 1 + "px";
            if (this.showCalendarButton) {
            ...
            var h = parseInt(j) / 2 - parseInt(d) / 2;
            if (h > 0) {
                var k = this.dateTimeInput.css("font-size");
                if ("" == k) {
                    k = 13
                }
                var h = j - 2 - parseInt(k) - 2;
                if (isNaN(h)) {
                    h = 0
                }
                if (h < 0) {
            ...
            if (this.rtl) {
                this.calendarButton[0].style.width = g + "px";
                this.timeButton[0].style.width = g + "px";
                this.calendarButton.css("left", "0px");
                if (this.showCalendarButton) {
                    this.timeButton.css("left", g + "px")
                } else {
        ...
        showCalendar: function() {
            ...
            var e, u = parseInt(Math.round(this.host.coord(true).left));
            e = u + "px";
